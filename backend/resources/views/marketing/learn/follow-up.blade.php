...
@section('title', __('learn.follow_up.meta_title'))

@section(
    'meta_description',
    __('learn.follow_up.meta_description')
)
...
<div class="container guide-hero-inner">
    ...
    <a
        ...
        class="guide-back"
    >
        {{ __('learn.follow_up.back') }}
    </a>

    <span class="guide-eyebrow">
        {{ __('learn.follow_up.eyebrow') }}
    </span>

    <h1 class="guide-title">
        {{ __('learn.follow_up.title') }}
    </h1>

    <p class="guide-lead">
        {{ __('learn.follow_up.lead') }}
    </p>
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.follow_up.nav_title') }}
    </span>

    @foreach(__('learn.follow_up.nav') as $anchor => $label)
        <a href="#{{ $anchor }}">
            {{ $label }}
        </a>
    @endforeach
...
@foreach(__('learn.follow_up.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>{{ __('learn.follow_up.checklist_title') }}</h2>

    <p>{{ __('learn.follow_up.checklist_description') }}</p>

    <div class="guide-checklist">

        @foreach(__('learn.follow_up.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>{{ __('learn.follow_up.cta.title') }}</h2>

        <p>{{ __('learn.follow_up.cta.description') }}</p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.follow_up.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.sales') }}"
                class="button button-secondary"
            >
                {{ __('learn.follow_up.cta.previous') }}
            </a>
