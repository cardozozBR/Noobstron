...
@section('title', __('learn.ai.meta_title'))

@section(
    'meta_description',
    __('learn.ai.meta_description')
)
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.ai.nav_title') }}
    </span>

    @foreach(__('learn.ai.nav') as $anchor => $label)
...
@foreach(__('learn.ai.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>
        {{ __('learn.ai.checklist_title') }}
    </h2>

    <p>
        {{ __('learn.ai.checklist_description') }}
    </p>

    <div class="guide-checklist">

        @foreach(__('learn.ai.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>
            {{ __('learn.ai.cta.title') }}
        </h2>

        <p>
            {{ __('learn.ai.cta.description') }}
        </p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.ai.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.routine') }}"
                class="button button-secondary"
            >
                {{ __('learn.ai.cta.previous') }}
            </a>
