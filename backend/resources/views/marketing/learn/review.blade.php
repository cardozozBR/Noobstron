...
@section('title', __('learn.review.meta_title'))

@section(
    'meta_description',
    __('learn.review.meta_description')
)
...
<div class="container guide-hero-inner">
    ...
    <a
        ...
        class="guide-back"
    >
        {{ __('learn.review.back') }}
    </a>

    <span class="guide-eyebrow">
        {{ __('learn.review.eyebrow') }}
    </span>

    <h1 class="guide-title">
        {{ __('learn.review.title') }}
    </h1>

    <p class="guide-lead">
        {{ __('learn.review.lead') }}
    </p>
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.review.nav_title') }}
    </span>

    @foreach(__('learn.review.nav') as $anchor => $label)
...
@foreach(__('learn.review.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>
        {{ __('learn.review.checklist_title') }}
    </h2>

    <p>
        {{ __('learn.review.checklist_description') }}
    </p>

    <div class="guide-checklist">

        @foreach(__('learn.review.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>
            {{ __('learn.review.cta.title') }}
        </h2>

        <p>
            {{ __('learn.review.cta.description') }}
        </p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.review.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.ai') }}"
                class="button button-secondary"
            >
                {{ __('learn.review.cta.previous') }}
            </a>
