...
@section('title', __('learn.routine.meta_title'))

@section(
    'meta_description',
    __('learn.routine.meta_description')
)
...
<div class="container guide-hero-inner">
    ...
    <a
        ...
        class="guide-back"
    >
        {{ __('learn.routine.back') }}
    </a>

    <span class="guide-eyebrow">
        {{ __('learn.routine.eyebrow') }}
    </span>

    <h1 class="guide-title">
        {{ __('learn.routine.title') }}
    </h1>

    <p class="guide-lead">
        {{ __('learn.routine.lead') }}
    </p>
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.routine.nav_title') }}
    </span>

    @foreach(__('learn.routine.nav') as $anchor => $label)
...
@foreach(__('learn.routine.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>
        {{ __('learn.routine.checklist_title') }}
    </h2>

    <p>
        {{ __('learn.routine.checklist_description') }}
    </p>

    <div class="guide-checklist">

        @foreach(__('learn.routine.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>
            {{ __('learn.routine.cta.title') }}
        </h2>

        <p>
            {{ __('learn.routine.cta.description') }}
        </p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.routine.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.automation') }}"
                class="button button-secondary"
            >
                {{ __('learn.routine.cta.previous') }}
            </a>
