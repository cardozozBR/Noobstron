...
@section('title', __('learn.communication.meta_title'))

@section(
    'meta_description',
    __('learn.communication.meta_description')
)
...
<div class="container guide-hero-inner">
    ...
    <a
        ...
        class="guide-back"
    >
        {{ __('learn.communication.back') }}
    </a>

    <span class="guide-eyebrow">
        {{ __('learn.communication.eyebrow') }}
    </span>

    <h1 class="guide-title">
        {{ __('learn.communication.title') }}
    </h1>

    <p class="guide-lead">
        {{ __('learn.communication.lead') }}
    </p>
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.communication.nav_title') }}
    </span>

    @foreach(__('learn.communication.nav') as $anchor => $label)
        <a href="#{{ $anchor }}">
            {{ $label }}
        </a>
    @endforeach
...
@foreach(__('learn.communication.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>{{ __('learn.communication.checklist_title') }}</h2>

    <p>{{ __('learn.communication.checklist_description') }}</p>

    <div class="guide-checklist">

        @foreach(__('learn.communication.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>{{ __('learn.communication.cta.title') }}</h2>

        <p>{{ __('learn.communication.cta.description') }}</p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.communication.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.follow-up') }}"
                class="button button-secondary"
            >
                {{ __('learn.communication.cta.previous') }}
            </a>
