...
@section('title', __('learn.results.meta_title'))

@section(
    'meta_description',
    __('learn.results.meta_description')
)
...
<div class="container guide-hero-inner">
    ...
    <a
        ...
        class="guide-back"
    >
        {{ __('learn.results.back') }}
    </a>

    <span class="guide-eyebrow">
        {{ __('learn.results.eyebrow') }}
    </span>

    <h1 class="guide-title">
        {{ __('learn.results.title') }}
    </h1>

    <p class="guide-lead">
        {{ __('learn.results.lead') }}
    </p>
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.results.nav_title') }}
    </span>

    @foreach(__('learn.results.nav') as $anchor => $label)
        <a href="#{{ $anchor }}">
            {{ $label }}
        </a>
    @endforeach
...
@foreach(__('learn.results.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>{{ __('learn.results.checklist_title') }}</h2>

    <p>{{ __('learn.results.checklist_description') }}</p>

    <div class="guide-checklist">

        @foreach(__('learn.results.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>{{ __('learn.results.cta.title') }}</h2>

        <p>{{ __('learn.results.cta.description') }}</p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.results.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.communication') }}"
                class="button button-secondary"
            >
                {{ __('learn.results.cta.previous') }}
            </a>
