...
@section('title', __('learn.automation.meta_title'))

@section(
    'meta_description',
    __('learn.automation.meta_description')
)
...
<div class="container guide-hero-inner">
    ...
    <a
        ...
        class="guide-back"
    >
        {{ __('learn.automation.back') }}
    </a>

    <span class="guide-eyebrow">
        {{ __('learn.automation.eyebrow') }}
    </span>

    <h1 class="guide-title">
        {{ __('learn.automation.title') }}
    </h1>

    <p class="guide-lead">
        {{ __('learn.automation.lead') }}
    </p>
...
<aside class="guide-nav">
    ...
    <span class="guide-nav-title">
        {{ __('learn.automation.nav_title') }}
    </span>

    @foreach(__('learn.automation.nav') as $anchor => $label)
...
@foreach(__('learn.automation.sections') as $index => $section)
...
<section class="guide-section">
    ...
    <h2>
        {{ __('learn.automation.checklist_title') }}
    </h2>

    <p>
        {{ __('learn.automation.checklist_description') }}
    </p>

    <div class="guide-checklist">

        @foreach(__('learn.automation.checklist') as $item)
    ...
    <div class="guide-next">
        ...
        <h2>
            {{ __('learn.automation.cta.title') }}
        </h2>

        <p>
            {{ __('learn.automation.cta.description') }}
        </p>
        ...
        <div class="guide-actions">
            ...
            <a
                ...
                class="button"
            >
                {{ __('learn.automation.cta.trial') }}
            </a>

            <a
                href="{{ route('marketing.learn.results') }}"
                class="button button-secondary"
            >
                {{ __('learn.automation.cta.previous') }}
            </a>
