...
return [
    ...
    'index' => [
        ...
        'cards' => [
            ...
            'ai' => [
                'number' => '09',
                'title' => 'Use AI in your sales process',
                'description' => 'Accelerate research, messages, summaries, and prioritization with AI without losing context, review, or accountability.',
                'action' => 'Open guide →',
            ],
            'review' => [
                'number' => '10',
                'title' => 'Review and improve your process',
                'description' => 'Use data, feedback, and small experiments to identify bottlenecks and continuously improve your sales operation.',
                'action' => 'Open guide →',
            ],
        ],
    ...
    'ai' => [
        'meta_title' => 'How to use AI in your sales process — Noobstron',
        'meta_description' => 'Learn how to use artificial intelligence in your sales process to research, prepare messages, summarize information, prioritize opportunities, and support decisions without losing human control.',

        'back' => '← Learning Center',
        'eyebrow' => 'Guide 09 • Artificial intelligence',
        'title' => 'How to use AI in your sales process.',
        'lead' => 'Artificial intelligence can accelerate sales tasks, organize information, and support decisions. In this guide, you will learn where AI can truly help, what precautions to take, and how to use it as support without replacing context, responsibility, or human judgment.',

        'nav_title' => 'In this guide',

        'nav' => [
            'papel' => '1. Understand the role of AI',
            'contexto' => '2. Provide enough context',
            'pesquisa' => '3. Use AI for research',
            'mensagens' => '4. Prepare better messages',
            'resumos' => '5. Summarize information',
            'priorizacao' => '6. Support prioritization',
            'qualidade' => '7. Review before using',
            'dados' => '8. Protect sensitive data',
            'limites' => '9. Know when not to automate',
            'noobstron' => '10. Apply it in Noobstron',
        ],
        ...
        'sections' => [
            [
                'id' => 'papel',
                'title' => 'Use AI as support, not as a replacement for your process',
                'paragraphs' => [
                    'AI can accelerate sales work, but it works best when there is a clear process, organized data, and well-defined objectives.',
                    'The most useful role of AI is to help people analyze, prepare, and execute tasks with greater speed and consistency.',
                ],
                'box_title' => 'AI does not eliminate responsibility',
                'box_text' => 'Even when a suggestion is generated automatically, the final decision remains the responsibility of the person using the information.',
            ],
            [
                'id' => 'contexto',
                'title' => 'Provide enough context to get better answers',
                'paragraphs' => [
                    'AI can only work with the information it receives.',
                    'Generic requests tend to produce generic answers. The better the context, the more useful the result tends to be.',
                ],
                'subtitle' => 'Include when relevant',
                'items' => [
                ...
                'after_list' => 'Providing enough context does not mean sharing every piece of information. Sensitive data still requires care.',
            ],
            [
                'id' => 'pesquisa',
                'title' => 'Use AI to accelerate research and preparation',
                'paragraphs' => [
                    'Before a sales conversation, AI can help organize questions, structure hypotheses, and prepare points that deserve further investigation.',
                    'It can also transform scattered information into a structure that is easier to review.',
                ],
                'subtitle' => 'Examples of use',
                'items' => [
                    'Prepare questions for a meeting.',
                    'Organize information about an industry.',
                    'Create an initial list of possible objections.',
                    'Structure qualification criteria.',
                    'Compare information that is already available.',
                ],
                'example_title' => 'Example',
                'example_text' => 'Before a meeting, you can provide context about the customer and ask for a list of questions to understand the problem, urgency, budget, and decision-making process.',
            ],
            [
                'id' => 'mensagens',
                'title' => 'Use AI to prepare better messages',
                'paragraphs' => [
                    'AI can help transform CRM information into drafts for emails, follow-up messages, and sales responses.',
                    'The benefit is reducing preparation time without turning every interaction into generic text.',
                ],
                'subtitle' => 'Ask AI to help you',
                'items' => [
                    'Create a first draft.',
                    'Summarize a long message.',
                    'Adjust tone and clarity.',
                    'Create shorter alternatives.',
                    'Turn notes into an organized message.',
                ],
                'box_title' => 'Review before sending',
                'box_text' => 'Names, amounts, deadlines, promises, and sales context should be checked by a person before the message is sent.',
            ],
            [
                'id' => 'resumos',
                'title' => 'Summarize information to recover context faster',
                'paragraphs' => [
                    'When an opportunity contains many notes, activities, and messages, quickly finding what matters can take time.',
                    'AI can help summarize the history and highlight decisions, pending items, and next steps.',
                ],
                'subtitle' => 'A useful summary can highlight',
                'items' => [
                    'The customer’s main need.',
                    'Recent interactions.',
                    'Objections raised.',
                ...
                'after_list' => 'A summary makes information easier to review, but the original history remains the source of reference whenever a detail is important.',
            ],
            [
                'id' => 'priorizacao',
                'title' => 'Use AI to support prioritization, not to decide on its own',
                'paragraphs' => [
                    'In operations with many opportunities, AI can help identify patterns and organize prioritization criteria.',
                    'This type of support is useful when the criteria are clear and can be explained.',
                ],
                'subtitle' => 'Criteria that can be included in the analysis',
                'items' => [
                    'Time since the last contact.',
                    'Opportunity stage.',
                    'Potential value.',
                    ...
                    'Recent signs of interest.',
                ],
                'example_title' => 'Example',
                'example_text' => 'AI can help order a list of opportunities using criteria defined by the team, while the salesperson remains responsible for validating the priority.',
            ],
            [
                'id' => 'qualidade',
                'title' => 'Review facts, language, and recommendations',
                'paragraphs' => [
                    'AI models can produce convincing answers even when some information is incorrect, incomplete, or interpreted inappropriately.',
                    'For this reason, any output that may affect the sales process should be reviewed.',
                ],
                'subtitle' => 'Check especially',
                'items' => [
                    'Names and companies.',
                    ...
                    'Commitments made.',
                    'Conclusions that do not appear in the original data.',
                ],
                'box_title' => 'Well-written text does not mean correct information',
                'box_text' => 'The quality of the language does not replace fact-checking.',
            ],
            [
                'id' => 'dados',
                'title' => 'Protect sensitive data when using AI',
                'paragraphs' => [
                    'Sales information may include personal data, prices, contracts, credentials, and strategic details.',
                    'Before sending information to any AI tool, understand which data actually needs to be used.',
                ],
                'subtitle' => 'Good practices',
                'items' => [
                    'Share only what is necessary.',
                    'Avoid passwords and credentials.',
                    'Do not send sensitive data without a clear need.',
                    'Consider anonymizing information.',
                    'Follow internal policies and legal requirements.',
                    'Use tools approved by your organization.',
                ],
                'after_list' => 'The more sensitive the data, the greater the care required regarding where it is processed and who can access it.',
            ],
            [
                'id' => 'limites',
                'title' => 'Know when to keep the decision entirely human',
                'paragraphs' => [
                    'Not every sales task should be delegated to or automated with AI.',
                    'Situations involving high impact, ambiguity, delicate negotiation, or significant consequences require human judgment.',
                ],
                'subtitle' => 'Keep human attention in situations such as',
                'items' => [
                    ...
                    'Messages that may significantly affect the relationship.',
                ],
                'after_list' => 'AI can prepare information for these situations, but it should not automatically make important decisions.',
            ],
            [
                'id' => 'noobstron',
                'title' => 'How to apply AI in Noobstron',
                'paragraphs' => [
                    'In Noobstron, AI can support different stages of the sales process using context already organized across customers, activities, opportunities, and history.',
                    'The goal is to reduce preparation work and help the team recover context, produce drafts, and identify next steps more quickly.',
                ],
                'subtitle' => 'Recommended sequence',
                'items' => [
                    'Choose a simple, repetitive task.',
                    'Define what context the AI needs.',
                    'Use only the minimum necessary information.',
                    'Generate a suggestion or draft.',
                    'Review the result.',
                    'Correct incorrect or incomplete information.',
                    'Only then use the output in the sales process.',
                ],
                'example_title' => 'Expected result',
                'example_text' => 'The team saves time on preparation and organization while people remain responsible for decisions, relationships, and final quality.',
            ],
        ],

        'checklist_title' => 'Checklist for using AI responsibly',
        'checklist_description' => 'Before using AI-generated output in your sales process, make sure context, quality, and responsibility remain under control.',

        'checklist' => [
            'The task has a clear objective.',
            'The AI received enough context.',
            'Only necessary data was used.',
            'Important information was verified.',
            'The output was reviewed by a person.',
            'High-impact decisions remain human.',
            'Using AI actually saves time or improves quality.',
        ],

        'cta' => [
            'title' => 'Use AI to gain speed without losing judgment.',
            'description' => 'Combine organized context, human review, and artificial intelligence to work more efficiently without giving up responsibility.',
            'trial' => 'Start my trial',
            'previous' => 'View sales routine guide',
        ],
    ],
    'review' => [
        'meta_title' => 'How to review and improve your sales process — Noobstron',
        'meta_description' => 'Learn how to review results, identify bottlenecks, adjust stages, improve activities, and continuously evolve your sales process.',

        'back' => '← Learning Center',
        'eyebrow' => 'Guide 10 • Review and continuous improvement',
        'title' => 'How to review and improve your sales process.',
        'lead' => 'A healthy sales process does not stand still. In this guide, you will learn how to review what is working, identify bottlenecks, correct problems, and turn data and team experience into continuous improvements.',

        'nav_title' => 'In this guide',

        'nav' => [
            'objetivo' => '1. Understand why review matters',
            'frequencia' => '2. Define a review frequency',
            'dados' => '3. Use data as a reference',
            'gargalos' => '4. Identify bottlenecks',
            'etapas' => '5. Review process stages',
            'atividades' => '6. Review activities',
            'equipe' => '7. Listen to the team',
            'experimentos' => '8. Make small changes',
            'documentacao' => '9. Record what changed',
            'noobstron' => '10. Apply it in Noobstron',
        ],
        ...
        'sections' => [
            [
                'id' => 'objetivo',
                'title' => 'Understand why the process needs to be reviewed',
                'paragraphs' => [
                    'Even a process that works well today may stop working when volume, market conditions, the team, or the customer profile changes.',
                    'Reviewing the process means confirming whether it still helps the team sell with clarity, consistency, and predictability.',
                ],
                'box_title' => 'Even a good process can become outdated',
                'box_text' => 'A rule that made sense six months ago may have become slow, unnecessary, or unsuitable for the current operation.',
            ],
            [
                'id' => 'frequencia',
                'title' => 'Define a review frequency',
                'paragraphs' => [
                    'Continuous improvement works better when there is a review routine instead of changes being made only when a serious problem appears.',
                    'The frequency depends on the pace of the operation, but it needs to be predictable enough to create discipline.',
                ],
                'subtitle' => 'Examples of reviews',
                'items' => [
                    'Weekly pipeline and activity review.',
                    'Monthly metrics review.',
                    'Quarterly review of the full process.',
                    'Extra review after important changes.',
                ],
                'after_list' => 'Not every review needs to produce a change. Sometimes confirming that the process still works is already a valid outcome.',
            ],
            [
                'id' => 'dados',
                'title' => 'Use data as a reference for the discussion',
                'paragraphs' => [
                    'Team opinions are important, but they become more useful when they can be compared with process data.',
                    'Metrics help separate recurring problems from isolated situations.',
                ],
                'subtitle' => 'Watch metrics such as',
                'items' => [
                ...
                'example_title' => 'Example',
                'example_text' => 'If many opportunities reach the proposal stage but few move forward after that, investigate pricing, qualification, timing, value proposition, or follow-up approach.',
            ],
            [
                'id' => 'gargalos',
                'title' => 'Identify where the process loses speed',
                'paragraphs' => [
                    'Bottlenecks appear when a stage concentrates delays, rework, uncertainty, or lost opportunities.',
                    'They may come from the process, tools, responsibility distribution, or information quality.',
                ],
                'subtitle' => 'Signs of a bottleneck',
                'items' => [
                    'Many opportunities accumulated in the same stage.',
                    'Activities frequently overdue.',
                    'Incomplete data.',
                    'Excessive dependency on one person.',
                    'Slow approvals.',
                    'Customers waiting too long for answers.',
                ],
                'box_title' => 'Look for the cause, not only the symptom',
                'box_text' => 'If tasks are constantly late, the problem may not be lack of effort. There may be too many stages, unclear priorities, or poorly distributed workload.',
            ],
            [
                'id' => 'etapas',
                'title' => 'Review whether the stages still represent reality',
                'paragraphs' => [
                    'Pipeline stages should represent real moments in the sales process.',
                    'If the team does not know when to move an opportunity or interprets stages differently, the pipeline loses value.',
                ],
                'subtitle' => 'Ask about each stage',
                'items' => [
                    'Is there a clear entry criterion?',
                    'Is there a clear exit criterion?',
                    'Does this stage support a decision?',
                    'Does it still happen in practice?',
                    'Is any stage redundant?',
                    'Is an important stage missing?',
                ],
                'after_list' => 'The simpler and more objective the structure is, the easier it becomes to keep the pipeline reliable.',
            ],
            [
                'id' => 'atividades',
                'title' => 'Review whether activities help move sales forward',
                'paragraphs' => [
                    'A routine full of tasks does not necessarily mean an efficient process.',
                    'Activities should exist because they help move opportunities, maintain relationships, or preserve organization.',
                ],
                'subtitle' => 'Review especially',
                'items' => [
                    'Repetitive tasks that could be automated.',
                    'Activities created without a clear objective.',
                    'Excessive follow-ups.',
                    'Tasks that nobody completes.',
                    'Activities that do not generate progress.',
                ],
                'example_title' => 'Example',
                'example_text' => 'If a task is created for every opportunity but the team almost always cancels it, the rule may need to be reviewed instead of demanding more execution.',
            ],
            [
                'id' => 'equipe',
                'title' => 'Listen to the people who execute the process every day',
                'paragraphs' => [
                    'The team often notices operational problems before they become clearly visible in the metrics.',
                    'Structured conversations help uncover friction that numbers alone do not explain.',
                ],
                'subtitle' => 'Useful questions',
                'items' => [
                    'What takes the most time today?',
                    'Where is there rework?',
                    'What information is usually missing?',
                    'Which stages create confusion?',
                    'What task could be simplified?',
                    'What helps the most in daily work?',
                ],
                'after_list' => 'Feedback becomes more useful when it produces hypotheses that can be observed or tested.',
            ],
            [
                'id' => 'experimentos',
                'title' => 'Prefer small and measurable changes',
                'paragraphs' => [
                    'Changing many things at the same time makes it difficult to know what actually improved or worsened the result.',
                    'Whenever possible, turn changes into small experiments with an objective and evaluation period.',
                ],
                'subtitle' => 'A simple experiment defines',
                'items' => [
                    'Which problem will be addressed.',
                    'What change will be made.',
                    'Who will be affected.',
                    'How long it will be tested.',
                    'Which result will be observed.',
                ],
                'box_title' => 'Change without measurement becomes opinion',
                'box_text' => 'Defining what you expect to improve helps evaluate whether the change actually produced a benefit.',
            ],
            [
                'id' => 'documentacao',
                'title' => 'Record changes to preserve learning',
                'paragraphs' => [
                    'When rules and processes change without documentation, the team loses context about why a decision was made.',
                    'Simple documentation avoids repeating discussions and makes it easier to train new people.',
                ],
                'subtitle' => 'Record at least',
                'items' => [
                    'What changed.',
                    'Why it changed.',
                    'When it took effect.',
                    'Who is responsible.',
                    'Which result will be monitored.',
                ],
                'after_list' => 'Documentation does not need to be extensive. It only needs to be clear enough for another person to understand the decision.',
            ],
            [
                'id' => 'noobstron',
                'title' => 'How to review your process in Noobstron',
                'paragraphs' => [
                    'In Noobstron, customer, opportunity, activity, and results data can help build a practical view of what is working and what needs to be adjusted.',
                    'The goal is to turn daily CRM usage into learning that continuously improves the sales process.',
                ],
                'subtitle' => 'Recommended sequence',
                'items' => [
                    'Review metrics and pipeline.',
                    'Identify a specific problem.',
                    'Talk to the people who execute the process.',
                    'Define an improvement hypothesis.',
                    'Make a small change.',
                    'Monitor the result.',
                    'Record the learning and adjust again.',
                ],
                'example_title' => 'Expected result',
                'example_text' => 'The operation stops treating the sales process as something fixed and starts evolving it based on data, team experience, and observed results.',
            ],
        ],

        'checklist_title' => 'Continuous improvement checklist',
        'checklist_description' => 'Use this list to confirm that your review produces real learning and controlled changes.',

        'checklist' => [
            'There is a defined review frequency.',
            'Data and metrics are analyzed.',
            'Bottlenecks are investigated by cause.',
            'Stages and activities still make sense.',
            'The team participates in the review.',
            'Changes are small and measurable.',
            'Learnings and decisions are documented.',
        ],

        'cta' => [
            'title' => 'Turn your process into a learning system.',
            'description' => 'Review, test, measure, and adjust continuously to keep your sales operation simple, efficient, and ready to grow.',
            'trial' => 'Start my trial',
            'previous' => 'View AI sales process guide',
        ],
    ],];