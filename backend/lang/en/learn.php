...
return [
    ...
    'index' => [
        ...
        'cards' => [
            ...
            'routine' => [
                'number' => '08',
                'title' => 'Organize your sales routine',
                'description' => 'Structure priorities, follow-ups, activities, and opportunities to maintain a consistent sales routine.',
                'action' => 'Open guide →',
            ],
        ],
    ...
    'routine' => [
        'meta_title' => 'How to organize your sales routine — Noobstron',
        'meta_description' => 'Learn how to organize priorities, follow-ups, new leads, opportunities, activities, and reviews to maintain a consistent sales routine.',

        'back' => '← Learning Center',
        'eyebrow' => 'Guide 08 • Sales routine',
        'title' => 'How to organize your sales routine.',
        'lead' => 'A good sales routine turns your CRM into a daily work tool. In this guide, you will learn how to organize priorities, manage activities, and keep opportunities moving without relying only on memory.',

        'nav_title' => 'In this guide',

        'nav' => [
            'inicio' => '1. Start with what needs attention',
            'atrasadas' => '2. Resolve overdue activities',
            'leads' => '3. Work new leads',
            'follow-up' => '4. Execute follow-ups',
            'oportunidades' => '5. Review opportunities',
            'agenda' => '6. Protect your calendar',
            'crm' => '7. Update the CRM',
            'prioridades' => '8. Define priorities',
            'fim-do-dia' => '9. Close the day properly',
            'noobstron' => '10. Apply it in Noobstron',
        ],
        ...
        'sections' => [
            [
                ...
                'paragraphs' => [
                    'A sales routine becomes simpler when you begin by looking at real commitments and pending items instead of deciding everything again every morning.',
                    'The goal is to quickly identify what requires action today and what can wait.',
                ],
                'subtitle' => 'Start by checking',
                'items' => [
                    'Overdue activities.',
                    ...
                    'Important commitments for the day.',
                ],
                'box_title' => 'Priority should come from the process',
                'box_text' => 'When the CRM is up to date, you do not have to rely only on memory to decide what to do first.',
            ],
            [
                'id' => 'atrasadas',
                'title' => 'Resolve overdue activities before they pile up',
                'paragraphs' => [
                    'Overdue activities are a sign that something was left behind in the process.',
                    'Not every overdue activity still needs to be completed, but every overdue activity needs to be reviewed.',
                ],
                'subtitle' => 'For each overdue activity',
                'items' => [
                    'Complete it if it still makes sense.',
                    'Reschedule it if it needs to happen later.',
                    'Cancel it if it is no longer relevant.',
                    'Update the related opportunity.',
                    'Define the next step.',
                ],
                'after_list' => 'Avoid simply changing the date of every overdue task without reviewing the context.',
            ],
            [
                'id' => 'leads',
                'title' => 'Give new leads quick attention',
                'paragraphs' => [
                    'New leads lose value when they wait too long.',
                    'A consistent routine helps ensure that new entries are reviewed, qualified, and directed quickly.',
                ],
                'subtitle' => 'When reviewing a new lead',
                'items' => [
                    'Check the information received.',
                    'Identify source and context.',
                    'Evaluate whether there is a good fit.',
                    'Assign an owner.',
                    'Make the first contact.',
                    'Record the next action.',
                ],
                'example_title' => 'Example',
                'example_text' => 'If a lead arrives through a form in the morning, it can enter the first prospecting block of the day instead of sitting unnoticed until someone remembers it.',
            ],
            [
                'id' => 'follow-up',
                'title' => 'Make follow-up part of the routine',
                'paragraphs' => [
                    'Follow-up should not depend on manually remembering who needs a response.',
                    'When the next activity is defined at the end of every contact, the routine automatically shows who needs attention.',
                ],
                'subtitle' => 'Before making a follow-up',
                'items' => [
                    'Review the last contact.',
                    'Check the current stage.',
                    'Read important notes.',
                    'Understand the reason for the next contact.',
                    'Prepare a contextualized message.',
                ],
                'box_title' => 'Good follow-up has a reason',
                'box_text' => 'Contacting someone only to ask “any news?” usually creates less value than returning to the context and proposing a concrete next step.',
            ],
            [
                'id' => 'oportunidades',
                'title' => 'Review open opportunities every day',
                'paragraphs' => [
                    'Not every opportunity needs daily action, but all of them should remain visible and consistent with reality.',
                    'A short review helps identify stalled deals, incorrect stages, and opportunities without a future activity.',
                ],
                'subtitle' => 'Pay particular attention to',
                'items' => [
                    'Opportunities without a next activity.',
                    'Deals that have been stalled for too long.',
                    'Stages that no longer reflect the current situation.',
            ...
            [
                'id' => 'agenda',
                'title' => 'Protect time blocks on your calendar',
                'paragraphs' => [
                    'Responding to everything the moment it appears can fragment the day and reduce productivity.',
                    'Separating time blocks for different types of work helps preserve focus and consistency.',
                ],
                'subtitle' => 'Examples of blocks',
                'items' => [
                    'Prospecting.',
                    'Follow-ups.',
                    'Meetings.',
                ...
                'after_list' => 'The blocks do not need to be rigid. They exist to protect enough attention for the most important activities.',
            ],
            [
                'id' => 'crm',
                'title' => 'Update the CRM while the context is fresh',
                'paragraphs' => [
                    'Leaving all updates until the end of the week increases the chance of forgetting details.',
                    'Whenever possible, record important information right after a call, meeting, or relevant change.',
                ],
                'subtitle' => 'Update mainly',
                'items' => [
                    'Opportunity stage.',
                    'Next activity.',
                    'Important notes.',
                ...
                'example_title' => 'Example',
                'example_text' => 'After a meeting, spending a few minutes recording the decision, objections, and next action can save a lot of time during the next contact.',
            ],
            [
                'id' => 'prioridades',
                'title' => 'Define priorities using clear criteria',
                'paragraphs' => [
                    'When everything feels urgent, the team tends to work on whatever appears first.',
                    'Simple criteria help decide where to invest sales attention.',
                ],
                'subtitle' => 'You can consider',
                'items' => [
                ...
                'box_title' => 'Priority is not only about value',
                'box_text' => 'A large opportunity with poor fit may deserve less attention than a smaller opportunity with high probability and an upcoming decision.',
            ],
            [
                'id' => 'fim-do-dia',
                'title' => 'Close the day by preparing the next one',
                'paragraphs' => [
                    'A few minutes of review at the end of the day reduces the feeling of starting from zero the next morning.',
                    'The goal is to leave pending items visible and future activities organized.',
                ],
                'subtitle' => 'Before finishing',
                'items' => [
                    'Complete activities that were performed.',
                    'Reschedule what needs to move.',
                    'Check tomorrow’s tasks.',
                    'Update opportunities that changed.',
                    'Record important information.',
                    'Make sure active deals have a next step.',
                ],
                'after_list' => 'A well-closed routine reduces forgotten tasks and makes it easier to resume work the next day.',
            ],
            [
                'id' => 'noobstron',
                'title' => 'How to organize your routine in Noobstron',
                'paragraphs' => [
                    'In Noobstron, activities, leads, customers, and opportunities can form a clear work queue for the day.',
                    'When every interaction ends with updated information and a next action, the sales routine becomes more predictable and easier to follow.',
                ],
                'subtitle' => 'Recommended sequence',
                'items' => [
                    'Review overdue and today’s activities.',
                    'Work new leads.',
                    'Execute planned follow-ups.',
                    'Update opportunities after each contact.',
                    'Record new activities.',
                    'Review deals without a next action.',
                    'Prepare priorities for the next day.',
                ],
                'example_title' => 'Expected result',
                'example_text' => 'The team starts each day knowing where to focus, reduces forgotten tasks, and keeps the sales process updated while working.',
            ],
        ],

        'checklist_title' => 'Checklist for an organized sales routine',
        'checklist_description' => 'Check whether daily work is connected to the process instead of depending only on each person’s memory.',

        'checklist' => [
            'Overdue activities are reviewed daily.',
            'New leads receive quick attention.',
            'Follow-ups have context and a clear objective.',
            'Open opportunities have a next action.',
            'Important information is recorded in the CRM.',
            'Priorities follow clear criteria.',
            'The day ends with the next day prepared.',
        ],

        'cta' => [
            'title' => 'Turn organization into consistency.',
            'description' => 'Use a simple routine to keep leads, activities, and opportunities moving every day.',
            'trial' => 'Start my trial',
            'previous' => 'View automation and scale guide',
        ],
    ],];